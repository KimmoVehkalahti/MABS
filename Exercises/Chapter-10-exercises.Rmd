...
See Table 10.13 in the book and use the schizophrenia data (see below). Modify the R codes given in the **Examples of Chapter 10** to create suitable graphics and to analyse the data.
